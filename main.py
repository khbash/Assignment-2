...
print("У цій роботі я дослідила дані про землетруси за останній місяць і з’ясувала, що більшість поштовхів були слабкими (магнітудою 3.0–4.0), а найчастіше вони ставалися біля Аляски. Я перевірила власну гіпотезу про те, що «через ці землетруси мали виникати цунамі», але вона не підтвердилася: у даних для всіх стояв показник "0" у полі цунамі. Це доводить, що навіть при постійній активності Землі далеко не кожен поштовх є достатньо потужним або зміщує океанське дно для утворення великої хвилі.")